...
void run_get_region(std::string k3_tree_filename, std::string query_filename, bool check) {
    ...
    std::vector<sdsl::k3_tree<>::point_type> result;
...
int main(int argc, char **argv) {
    ...
    switch (k3_tree_type) {
        case sdsl::K3_TREE_TYPE_BASIC:
            run_get_region<sdsl::k3_tree<>, sdsl::k3_tree_base<>::pos_type>(k3_tree_filename, query_filename, check);
            break;
        case sdsl::K3_TREE_TYPE_POINTS:
            run_get_region<sdsl::k3_tree_points<>, sdsl::k3_tree_base<>::pos_type>(k3_tree_filename, query_filename, check);
            break;
        case sdsl::K3_TREE_TYPE_LEVEL:
            run_get_region<sdsl::k3_tree_level<>, sdsl::k3_tree_base<>::pos_type>(k3_tree_filename, query_filename, check);
            break;
        case sdsl::K3_TREE_TYPE_LIDAR_POINTS:
            run_get_region<sdsl::k3_tree_LIDAR_points<>, double>(k3_tree_filename, query_filename, check);
            break;
        default:
            print_help(argv[0]);
